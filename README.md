##### liu@1115:
this is a copied version of caffe R-FCN. The original intro is below.
This repo has a few minor changed to fit for my own work.
...
#liu@1114
when defining a new layer(e.g.: RpnClsOHEM layer), should add two things in caffe.proto:
(1) declare RpnClsOHEMParameter (20000 can be any other non-duplicated number):
optional RpnClsOHEMParameter rpn_cls_ohem_param = 20000; 
(2) define the detain of RpnClsOHEMParameter
message RpnClsOHEMParameter {
  required uint32 bg_per_img = 1; // number of bg rois for training
